...
(function(f){f.extend(mejs.MepDefaults,{speedText:"Speed"});f.extend(MediaElementPlayer.prototype,{buildspeed:function(a,b,c,d){if(a.isVideo)var e=f('<div class="mejs-button mejs-speed-button mejs-speed-normal"><button type="button" aria-controls="'+this.id+'" title="'+this.options.speedText+'"></button></div>').appendTo(b).click(function(){if(!d.paused&&!d.ended)if(d.playbackRate==2){d.playbackRate=1;e.removeClass("mejs-speed-double").addClass("mejs-speed-normal")}else{d.playbackRate=2;e.removeClass("mejs-speed-normal").addClass("mejs-speed-double")}})}})})(mejs.$);
...
(function(f){f.extend(mejs.MepDefaults,{skipText:"Back"});f.extend(MediaElementPlayer.prototype,{buildskip:function(a,b,c,d){f('<div class="mejs-button mejs-skip-button mejs-skip-back"><button type="button" aria-controls="'+this.id+'" title="'+this.options.skipText+'"></button></div>').appendTo(b).click(function(){newTime=d.currentTime-30;d.currentTime=newTime<0?0:newTime});f('<div class="mejs-button mejs-skip-button mejs-skip-forward"><button type="button" aria-controls="'+this.id+'" title="'+this.options.skipText+
'"></button></div>').appendTo(b).click(function(){newTime=d.currentTime+30;d.currentTime=newTime>d.duration?d.duration:newTime})}})})(mejs.$);
